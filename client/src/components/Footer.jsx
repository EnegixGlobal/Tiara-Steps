          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <img
                  src={logo}
                  alt="Tiara Steps Logo"
                  className="w-20 h-auto"
                />
              </div>
              <p className="text-gray-700 text-sm leading-relaxed">
                Step into elegance with Tiara Steps, where style meets comfort.
                Crafted for women who walk with confidence, grace, and timeless
                charm.
              </p>
              <div>
            ...
            <div className="mt-[20px]">
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/home"
                    className="text-gray-700 hover:text-[#b89396] transition-colors text-sm"
                  >
                    Home
                  </Link>
                </li>
            ...
            <div className="mt-[20px]">
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="flex items-center gap-3 text-gray-700 hover:text-[#b89396] transition-colors text-sm"
                >
                  <Phone size={18} />
                  <span>+91 9304978001</span>
                </a>
                <a
                  href="mailto:knowmore@tiarasteps.in"
                  className="flex items-center gap-3 text-gray-700 hover:text-[#b89396] transition-colors text-sm break-all"
                >
                  <Mail size={18} />
